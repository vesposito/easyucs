...
from config.ucs.lan import UcsSystemVlan, UcsSystemApplianceVlan, UcsSystemLanUplinkPort, UcsSystemLanPortChannel,\
...
from config.ucs.san import UcsSystemVsan, UcsSystemStorageVsan, UcsSystemSanUplinkPort, UcsSystemSanStoragePort,\
