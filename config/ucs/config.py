...
class UcsSystemConfig(GenericUcsConfig):
    ...
    def _fetch_sdk_objects(self, force=False):
        ...
        sdk_objects_to_fetch = [
            ...
            'computePowerSyncPolicy', 'computePsuPolicy', 'computeQual', 'computeRackQual', 'computeScrubPolicy',
            'computeServerDiscPolicy', 'computeServerMgmtPolicy', 'computeSlotQual', 'cpmaintMaintPolicy',
            'diagMemoryTest', 'diagRunPolicy', 'dpsecMac', 'epqosDefinition', 'epqosEgress', 'equipmentBinding',
            'equipmentChassisProfile', 'equipmentComputeConnPolicy', 'etherPIo', 'fabricBreakout', 'fabricDceSwSrvEp',
            'fabricDceSwSrvPcEp', 'fabricEthEstcEp', 'fabricEthEstcPc', 'fabricEthEstcPcEp', 'fabricEthLanEp',
            'fabricEthLanFlowMonitoring', 'fabricEthLanPc', 'fabricEthLanPcEp', 'fabricEthLinkProfile', 'fabricEthMon',
            'fabricEthMonDestEp', 'fabricEthMonSrcRef', 'fabricEthMonSrcEp', 'fabricEthTargetEp', 'fabricEthVlanPc',
            'fabricEthVlanPortEp', 'fabricFcEndpoint', 'fabricFcEstcEp', 'fabricFcMon', 'fabricFcMonSrcEp',
            'fabricFcMonSrcRef', 'fabricFcSan', 'fabricFcSanEp', 'fabricFcSanPc', 'fabricFcSanPcEp', 'fabricFcUserZone',
            'fabricFcVsanPc', 'fabricFcVsanPortEp', 'fabricFcZoneProfile', 'fabricFcoeEstcEp', 'fabricFcoeSanEp',
            'fabricFcoeSanPc', 'fabricFcoeSanPcEp', 'fabricFcoeVsanPortEp', 'fabricLacpPolicy', 'fabricLanCloud',
            'fabricLanCloudPolicy', 'fabricLanPinGroup', 'fabricLanPinTarget', 'fabricMulticastPolicy',
            'fabricNetGroup', 'fabricNetGroupRef', 'fabricOrgVlanPolicy', 'fabricPooledVlan', 'fabricReservedVlan',
            'fabricSanCloud', 'fabricSanPinGroup', 'fabricSanPinTarget', 'fabricUdldLinkPolicy', 'fabricUdldPolicy',
            'fabricVCon', 'fabricVConProfile', 'fabricVlan', 'fabricVlanGroupReq', 'fabricVlanReq', 'fabricVsan',
            'faultPolicy', 'fcPIo', 'fcpoolBlock', 'fcpoolInitiators', 'fcpoolOui', 'fcpoolOuis',
            'firmwareAutoSyncPolicy', 'firmwareChassisPack', 'firmwareComputeHostPack',
            'firmwareExcludeChassisComponent', 'firmwareExcludeServerComponent', 'firmwarePackItem',
            'flowctrlItem', 'ippoolBlock', 'ippoolIpV6Block', 'ippoolPool', 'iqnpoolBlock', 'iqnpoolPool',
            'iscsiAuthProfile', 'lsBinding', 'lsPower', 'lsRequirement', 'lsServer', 'lsServerExtension',
            'lsVConAssign', 'lsbootBootSecurity', 'lsbootDef', 'lsbootDefaultLocalImage', 'lsbootEFIShell',
            ...
            'vnicSanConnTempl', 'vnicSriovHpnConPolicy', 'vnicSriovHpnConPolicyRef', 'vnicUsnicConPolicy',
            'vnicUsnicConPolicyRef', 'vnicVhbaBehPolicy', 'vnicVlan', 'vnicVmqConPolicy', 'vnicVmqConPolicyRef',
